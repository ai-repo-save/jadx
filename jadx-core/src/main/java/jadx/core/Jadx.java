...
import jadx.core.dex.visitors.kotlin.coroutine.StateMachineVisitor;
import jadx.core.dex.visitors.kotlin.coroutine.SuspendFunctionVisitor;
...
import jadx.core.dex.visitors.kotlin.KotlinPropertyVisitor;
...
public class Jadx {
	...
	public static List<IDexTreeVisitor> getRegionsModePasses(JadxArgs args) {
		...
		// regions IR
		passes.add(new SuspendFunctionVisitor());
		passes.add(new StateMachineVisitor());
		...
		passes.add(new KotlinPropertyVisitor());
		passes.add(new KotlinDefaultArgsVisitor());
